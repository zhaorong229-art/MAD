...
parser.add_argument('--bkd_model', type=str, default='UGBA',
                    help='bkd_model',
...
log_file = os.path.join(log_dir, f'{args.vs_number}.log')
...
for test_model in models:
    ...
    for seed in seeds:
        ...
        if(args.defense_mode == 'prune' or args.defense_mode == 'isolate'):
            ...
            encoder_x_test = gcn_encoder.get_h(induct_x, induct_edge_index, induct_edge_weights).clone().detach()  # 获取编码后的特征向量
            ...
            y_pred_test = gcn_encoder.test(induct_x, induct_edge_index, induct_edge_weights)
            high_dist_edges_mask = anomaly_embedding_edge(args, induct_edge_index, induct_edge_weights, encoder_x_test, device)
